...
import com.codingbingoZTT.BanmaReader.ui.adapter.BookListAdapter;
import com.codingbingoZTT.BanmaReader.ui.fragment.MainControllerBottomSheetFragment;
...
import webview.WebMainActivity;
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.go_search_btn:
                Intent webintent = new Intent(this, WebMainActivity.class);
